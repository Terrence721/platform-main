...
export interface EntitySelectors$<T> {
  ...
  readonly entityMap$: Observable<Dictionary<T>>;
  ...
  readonly filteredEntities$: Observable<T[]>;

  /** Observable of the keys of the cached collection, in the collection's native sort order */
  readonly keys$: Observable<string[] | number[]>;
  ...
  readonly changeState$: Observable<ChangeStateMap<T>>;
}
